...
The code for this step is contained in the first and second code cells of the IPython notebook located in "./p4_prepare_data.ipynb" .  
...
The code for this step is contained in the 13st code cell of the IPython notebook located in "./p4.ipynb".  
...
The code for this step is contained in the 21st and 22st code cells of the IPython notebook located in "./p4.ipynb".
