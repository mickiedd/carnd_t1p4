...
def process_image(image):
    ...
    if process_count == 0:
        ...
        result, out_img, left_fitx, right_fitx, ploty = fit_lane_line_continue(image, binary_warped,
                                                                               invert_perspective_M)
    ...
    cv2.putText(result, str(left_curverad) + ',' + str(right_curverad), (50, 80), cv2.FONT_HERSHEY_SIMPLEX, 2,
